...
//        canvas.translate(500f, 400f)
        ...
        if (!startCount) {
            ...
            //绘制秒针
            paint.color = Color.RED
            val secondDegree = Math.toRadians (secondsInMinute * SECOND_DEGREE )
            canvas.drawLine(
                0f,
                0f,
            ...
            //绘制分针
            val minuteDegree =
               Math.toRadians (secondsInMinute / MINUTE *SECOND_DEGREE  + (minutes - 1)*SECOND_DEGREE )
            ...
            //绘制时针
            val hourDegree =
                Math.toRadians  (secondsInHour / HOUR *HOUR_DEGREE + (hours - 1)*HOUR_DEGREE )
